...
<div class="panel-heading">
	<h2 class="panel-title" align="center"><i class="fa fa-code"></i> 
		DAFTAR NAMA SISWA DITERIMA DI SMKN 1 MEJAYAN, JURUSAN <b>RPL</b></h2>
</div>
<div class="panel-body">

<center><h3>Daftar Nama Siswa yang diterima di Komptensi Keahlian <BR>
<b>REKAYASA PERANGKAT LUNAK</b> SMKN 1 Mejayan</h3></center>
<hr>
<div class="panel panel-default">
	...
	<div class="panel-body pengumuman2"><?php $queryjalan = mysqli_query($koneksi, "select * from info where untuk='rpl'") or die("GAGAL ".mysqli_error($koneksi)); while($jalan = mysqli_fetch_array($queryjalan)){ echo strtoupper($jalan['isi']); } ?>
	</div>
</div>
<hr>
...
<tbody>
<?php 
$query = mysqli_query($koneksi,"select * from bio_siswa where jurusan='RPL' and diterima='Y' order by rata_total desc limit 64");
$no=1;
...
<?php /*
	...
	<?php 
	$query = mysqli_query($koneksi,"select * from bio_siswa where jurusan='RPL' and diterima='N' order by rata_total desc limit 0,6"); $no=97; while($tampil = mysqli_fetch_array($query)){ ?>
		<tr>
