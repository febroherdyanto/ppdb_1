<div class='rightpanel'>
    ...
    <?php
    $tampil=mysqli_query($koneksi,"SELECT * FROM bio_siswa");
    ...
    while ($r=mysqli_fetch_array($tampil)){
      ...
      if($level == 'admin'){ ?>
      <a href="isi/hapussiswa.php?no=<?php echo $r['no_sementara']; ?>" onclick="return confirm('Anda Yakin untuk Menghapus data ini?')"><button class="btn-sm btn-danger btn-circle">Hapus</button></a>
      <?php }else{
        echo "";
      }
