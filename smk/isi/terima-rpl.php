...
<a href="index.php?halaman=Terima-TKR"><button class="btn-sm btn-warning">TKR</button></a>
<!-- ./lainnya -->

                <h2>Siswa diterima di Jurusan RPL</h2>
            </div>
        </div><!--pageheader-->
    ...
    <?php
    $tampil=mysqli_query($koneksi,"SELECT * FROM bio_siswa WHERE jurusan='RPL' AND diterima='Y' ORDER BY rata_total DESC LIMIT 60");
