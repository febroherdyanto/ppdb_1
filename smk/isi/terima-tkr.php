...
<!-- ./lainnya -->
                ...
                <h2>Siswa diterima di Jurusan TKR</h2>
            </div>
        </div><!--pageheader-->
    ...
    <?php
    $tampil=mysqli_query($koneksi,"SELECT * FROM bio_siswa WHERE jurusan='TKR' AND diterima='Y' ORDER BY rata_total DESC LIMIT 90");
